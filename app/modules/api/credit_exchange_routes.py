...
from app.services.admin_batch_service import batch_final_approve_credit_exchanges
...
def admin_batch_approve_credit_exchange_api():
    return _handle_business(lambda: ok(batch_final_approve_credit_exchanges(
