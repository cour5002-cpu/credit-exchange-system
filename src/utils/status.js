const STATUS_META = {
  ...
  pending_admin_accept: { text: '待管理员受理', color: 'warning' },
  admin_accepted: { text: '管理员已受理', color: 'success' },
  pending_reviewer: { text: '待审核老师审核', color: 'warning' },
  reviewer_approved: { text: '审核老师已通过', color: 'success' },
  reviewer_modified_approved: { text: '修改课时后通过', color: 'success' },
  ...
  modified_approved: { text: '修改课时后通过', color: 'success' },
