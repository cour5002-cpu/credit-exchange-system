...
<template><main class="final-page"><div class="page-content">
  ...
  <nav class="type-tabs" aria-label="最终确认类型"><RouterLink class="active" to="/admin/final-confirm">课时最终确认</RouterLink><RouterLink to="/admin/final-confirm/exchanges">学分兑换最终确认</RouterLink></nav>
