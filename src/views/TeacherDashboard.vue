...
import { getAdvisorPendingApplications, getAdvisorPendingSupplementApplications } from '../mock/applications.js'
...
const entries = computed(() => [
  ...
  { title: '待确认事项', description: `课时申请 ${pendingHours.value} 项，补交成果 ${pendingSupplements.value} 项，学分兑换 ${pendingExchanges.value} 项，任务成果 ${pendingResults.value} 项。`, to: '/teacher/confirm' },
